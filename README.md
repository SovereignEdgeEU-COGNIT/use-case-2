...
```
Finally, the requirements listed into `/root/useapp/requirements.txt` can be installed:
```
pip install -r /root/useapp/requirements.txt
```
## Function offload
...
* A string containing the error occurred during the execution of the function
